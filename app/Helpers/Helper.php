               ...
               foreach($cart as $c)
               {
                   ...
                   if($c['type'] == "auction")
                  {
                   ...
                   {                   	
                       ...
                       $merchant = User::where('id', $store->user_id)->first();
               	...
               	$this->fundWallet($receiverData);
                       ...
                       $tdt = [];
                   $tdt['type'] = "receive-sale";
                   $tdt['description'] = $order->number.','.$data['transaction-description'];                   
                   $tdt['user_id'] = $store->user_id;
